...
type SysOperLogSearchReq struct {
	g.Meta        `path:"/operLog/list" tags:"若依-操作日志" method:"get" summary:"操作日志列表"`
...
type SysOperLogGetReq struct {
	g.Meta `path:"/operLog/get" tags:"若依-操作日志" method:"get" summary:"获取操作日志信息"`
	commonApi.Author
	OperId int64 `p:"operId" v:"required#主键必须"` //通过主键获取
}
...
type SysOperLogDeleteReq struct {
	g.Meta `path:"/operLog/delete" tags:"若依-操作日志" method:"delete" summary:"删除操作日志"`
	commonApi.Author
	OperIds []int64 `p:"operIds" v:"required#主键必须"` //通过主键删除
}
...
type SysOperLogClearReq struct {
	g.Meta `path:"/operLog/clear" tags:"若依-操作日志" method:"delete" summary:"清除日志"`
	commonApi.Author
}
