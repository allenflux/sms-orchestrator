...
type GetDictReq struct {
	g.Meta `path:"/dict/data/getDictData" tags:"若依-字典管理" method:"get" summary:"获取字典数据公共方法"`
	commonApi.Author
...
type DictDataSearchReq struct {
	g.Meta    `path:"/dict/data/list" tags:"若依-字典管理" method:"get" summary:"字典数据列表"`
...
type DictDataAddReq struct {
	g.Meta `path:"/dict/data/add" tags:"若依-字典管理" method:"post" summary:"添加字典数据"`
	*DictDataReq
}
...
type DictDataGetReq struct {
	g.Meta   `path:"/dict/data/get" tags:"若依-字典管理" method:"get" summary:"获取字典数据"`
...
type DictDataEditReq struct {
	g.Meta   `path:"/dict/data/edit" tags:"若依-字典管理" method:"put" summary:"修改字典数据"`
...
type DictDataDeleteReq struct {
	g.Meta `path:"/dict/data/delete" tags:"若依-字典管理" method:"delete" summary:"删除字典数据"`
	Ids    []int `p:"ids"`
}
