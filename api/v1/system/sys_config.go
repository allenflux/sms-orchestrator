...
import (
	...
	commonEntity "sms_backend/internal/model/entity"
)

type ConfigSearchReq struct {
	g.Meta     `path:"/config/list" tags:"若依-系统参数管理" method:"get" summary:"系统参数列表"`
...
type ConfigAddReq struct {
	g.Meta `path:"/config/add" tags:"若依-系统参数管理" method:"post" summary:"添加系统参数"`
	*ConfigReq
}
...
type ConfigGetReq struct {
	g.Meta `path:"/config/get" tags:"若依-系统参数管理" method:"get" summary:"获取系统参数"`
	Id     int `p:"id"`
}
...
type ConfigEditReq struct {
	g.Meta   `path:"/config/edit" tags:"若依-系统参数管理" method:"put" summary:"修改系统参数"`
...
type ConfigDeleteReq struct {
	g.Meta `path:"/config/delete" tags:"若依-系统参数管理" method:"delete" summary:"删除系统参数"`
	Ids    []int `p:"ids"`
}
...
type ConfigGetOneByKeyReq struct {
	g.Meta `path:"/config/get-one-by-key" tags:"若依-系统参数管理" method:"get" summary:"通过key获取系统参数"`
	Key    string `p:"key" dc:"key值"`
}

type ConfigGetOneByKeyRes struct {
	Data *commonEntity.SysConfig `json:"data"`
}
