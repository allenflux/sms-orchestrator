...
type PersonalInfoReq struct {
	g.Meta `path:"/personal/getPersonalInfo" tags:"若依-用户管理" method:"get" summary:"登录用户信息"`
	commonApi.Author
}
...
type PersonalEditReq struct {
	g.Meta `path:"/personal/edit" tags:"若依-用户管理" method:"put" summary:"修改个人资料"`
	*SetPersonalReq
	commonApi.Author
}
...
type PersonalResetPwdReq struct {
	g.Meta   `path:"/personal/resetPwd" tags:"若依-用户管理" method:"put" summary:"重置个人密码"`
