...
type DbInitIsInitReq struct {
	g.Meta `path:"/dbInit/isInit" tags:"若依-系统初始化" method:"get" summary:"系统初始化"`
}

type DbInitIsInitRes bool

type DbInitGetEnvInfoReq struct {
	g.Meta `path:"/dbInit/getEnvInfo" tags:"若依-系统初始化" method:"get" summary:"获取环境信息"`
}

type DbInitGetEnvInfoRes g.Map

type DbInitCreateDbReq struct {
	g.Meta       `path:"/dbInit/createDb" tags:"若依-系统初始化" method:"post" summary:"创建配置文件"`
