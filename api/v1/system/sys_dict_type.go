...
import (
	...
	commonModel "sms_backend/internal/model"
	commonEntity "sms_backend/internal/model/entity"
)

type DictTypeSearchReq struct {
	g.Meta   `path:"/dict/type/list" tags:"若依-字典管理" method:"get" summary:"字典类型列表"`
...
type DictTypeAddReq struct {
	g.Meta   `path:"/dict/type/add" tags:"若依-字典管理" method:"post" summary:"添加字典类型"`
...
type DictTypeGetReq struct {
	g.Meta `path:"/dict/type/get" tags:"若依-字典管理" method:"get" summary:"获取字典类型"`
	DictId int `p:"dictId" v:"required#类型id不能为空"`
}
...
type DictTypeEditReq struct {
	g.Meta   `path:"/dict/type/edit" tags:"若依-字典管理" method:"put" summary:"修改字典类型"`
...
type DictTypeDeleteReq struct {
	g.Meta  `path:"/dict/type/delete" tags:"若依-字典管理" method:"delete" summary:"删除字典类型"`
...
type DictTypeAllReq struct {
	g.Meta `path:"/dict/type/optionSelect" tags:"若依-字典管理" method:"get" summary:"获取字典选择框列表"`
}
