...
type UserMenusReq struct {
	g.Meta `path:"/user/getUserMenus" tags:"若依-用户管理" method:"get" summary:"获取用户菜单"`
	commonApi.Author
}
...
type UserSearchReq struct {
	g.Meta   `path:"/user/list" tags:"若依-用户管理" method:"post" summary:"用户列表"`
...
type UserGetParamsReq struct {
	g.Meta `path:"/user/params" tags:"若依-用户管理" method:"get" summary:"用户维护参数获取"`
}
...
type UserAddReq struct {
	g.Meta `path:"/user/add" tags:"若依-用户管理" method:"post" summary:"添加用户"`
	*SetUserReq
...
type UserEditReq struct {
	g.Meta `path:"/user/edit" tags:"若依-用户管理" method:"put" summary:"修改用户"`
	*SetUserReq
...
type UserGetEditReq struct {
	g.Meta `path:"/user/getEdit" tags:"若依-用户管理" method:"get" summary:"获取用户信息"`
	Id     int64 `p:"id"`
}
...
type UserGetEditRes struct {
	...
	CheckedRoleIds []int           `json:"checkedRoleIds"`
	CheckedPosts   []int64         `json:"checkedPosts"`
}

// UserResetPwdReq 重置用户密码状态参数
type UserResetPwdReq struct {
	g.Meta   `path:"/user/resetPwd" tags:"若依-用户管理" method:"put" summary:"重置用户密码"`
	Id       int64  `p:"userId" v:"required#用户id不能为空"`
	Password string `p:"password" v:"required|password#密码不能为空|密码以字母开头，只能包含字母、数字和下划线，长度在6~18之间"`
}
...
type UserStatusReq struct {
	g.Meta     `path:"/user/setStatus" tags:"若依-用户管理" method:"put" summary:"设置用户状态"`
	Id         int64 `p:"userId" v:"required#用户id不能为空"`
...
type UserDeleteReq struct {
	g.Meta `path:"/user/delete" tags:"若依-用户管理" method:"delete" summary:"删除用户"`
...
type UserGetByIdsReq struct {
	g.Meta `path:"/user/getUsers" tags:"若依-用户管理" method:"get" summary:"同时获取多个用户"`
	commonApi.Author
	Ids []int `p:"ids" v:"required#ids不能为空"`
}
