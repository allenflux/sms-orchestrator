...
type SmsChartLog struct {
	...
	SentOrReceive       interface{} // 1表示此条短信是发送 2表示此条短信是接收
	AssociatedAccountId interface{} // 子账号id
	RowHash             interface{} // log hash 防止重复上报
	TaskId              interface{} // Mission Task的id 任务 id
}
