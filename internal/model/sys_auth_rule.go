...
type SysAuthRuleInfoRes struct {
	...
	MenuType  int    `orm:"menu_type"   json:"menuType"`  // 类型 0目录 1菜单 2按钮
	Weigh     int    `orm:"weigh"       json:"weigh"`     // 权重
	IsHide    int    `orm:"is_hide" json:"isHide"`        // 显示状态
	IsCached  int    `orm:"is_cached"  json:"isCached"`   // 是否缓存
	IsAffix   int    `orm:"is_affix" json:"isAffix"`      //是否固定
	...
	IsIframe  int    `orm:"is_iframe"    json:"isIframe"` // 是否iframe
	IsLink    int    `orm:"is_link" json:"isLink"`        // 是否外链 1是 0否
