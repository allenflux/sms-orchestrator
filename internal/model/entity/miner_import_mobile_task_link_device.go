...
// MinerImportMobileTaskLinkDevice is the golang structure for table miner_import_mobile_task_link_device.
type MinerImportMobileTaskLinkDevice struct {
	...
	MinerImportMobileTaskId int         `json:"miner_import_mobile_task_id" orm:"miner_import_mobile_task_id" description:"矿机导入通讯录任务ID"`                       // 矿机导入通讯录任务ID
	...
	FailNum                 int         `json:"fail_num"                    orm:"fail_num"                    description:"导入失败通讯录数量"`                         // 导入失败通讯录数量
	SuccessNum              int         `json:"success_num"                 orm:"success_num"                 description:"导入成功通讯录数量"`                         // 导入成功通讯录数量
